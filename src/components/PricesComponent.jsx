...
function PricesComponent ({ historyData, priceData, getImage }) {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '42px 1fr 1fr', alignItems: 'center' }}>
                ...
                <div style={{ textAlign: 'center', paddingTop: 10, transform: 'scale(0.9)' }}>
                    <span style={{ fontSize: 24, letterSpacing: 1 }}>
                        {usdSelected ? <span style={{ fontSize: 14, whiteSpace: 'nowrap' }}>$ </span> : ''}{displayPrice ?? '-'}{usdSelected ? '' : <span style={{ fontSize: 12 }}> WPLS / DAI</span>}
                    </span>
                </div>
                ...
                <div style={{ textAlign: 'center', paddingTop: 0, fontSize: 24 }}>
                    {isLoading && selected !== 'ATL' ? <span>
                            <Tooltip content="Loading Historical Data...">
                                <div style={{ fontSize: 15, fontFamily: 'sans-serif' }} className="desktop-only">
                                    Loading history from blockchain...<br/>This may take up to 30~60s
                                </div>
                                <div style={{ fontSize: 15, fontFamily: 'sans-serif' }} className="mobile-only">
                                    Loading...
                                </div>
